package com.yeven.thread.framework.plugin.core;

import com.yeven.thread.framework.plugin.common.NamedContribution;
import com.yeven.thread.framework.plugin.graph.GraphContribution;
import com.yeven.thread.framework.plugin.graph.GraphContributor;
import com.yeven.thread.framework.plugin.pipeline.PipelineContribution;
import com.yeven.thread.framework.plugin.pipeline.PipelineContributor;
import com.yeven.thread.framework.plugin.runtime.RuntimeContribution;
import com.yeven.thread.framework.plugin.runtime.RuntimeProvider;
import com.yeven.thread.framework.plugin.slot.SlotSchemaContribution;
import com.yeven.thread.framework.plugin.slot.SlotSchemaContributor;
